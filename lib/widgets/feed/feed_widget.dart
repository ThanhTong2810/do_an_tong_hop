            ...
            children: postsController.listPosts.map((post){
              return Column(
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text('Ho Chi Minh, Viet Nam', style: Theme.of(context).textTheme.caption,)
                              ],
                            ),
                          ),
                        ),
                  ...
                  post.imageSrc.isNotEmpty?AspectRatio(
                    aspectRatio: 1,
                    child: PageView(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        IconButton(
                            ...
                            onPressed: (){
                              Get.to(()=>CommentPage(idOwner: post.idAccount, idPost: post.idPost, comments: post.comments,));
                            }),
                        IconButton(
                            icon: SvgPicture.asset(
                              IconsApp.icSend,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          ...
                          onTap: (){
                            Get.to(()=>CommentPage(idOwner: post.idAccount, idPost: post.idPost,));
                          },
                        )
                      ],
                    ),
