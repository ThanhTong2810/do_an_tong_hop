...
class CommentPostsApi extends DoAnApi {
  CommentPostsApi() : super();

  Future<ApiResponse> commentPostsApi({String idPost, String idOwner, String idAccount, String contentHtml, List<String> mentionList}) async {
    var dataSend = {
      "id_post": idPost,
      "id_owner": idOwner,
