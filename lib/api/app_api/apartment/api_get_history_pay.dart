...
class GetHistoryApartmentApi extends DoAnApi {
  GetHistoryApartmentApi() : super();

  Future<ApiResponse> getHistoryApartmentApi({String id}) async {
    var dataSend = {
      "id": id,
    };
