...
class FollowAccountApi extends DoAnApi {
  FollowAccountApi() : super();

  Future<ApiResponse> followAccountApi({String myId, String followingId}) async {
    ApiResponse apiResponse;
    try {
      Response response = await DoAnApi.httpClient.post(
        '${DoAnApi.POST_FOLLOW_ACCOUNT}?myId=$myId&followingId=$followingId',
      );
