...
class GetPostsByIdApi extends DoAnApi {
  GetPostsByIdApi() : super();

  Future<ApiResponse> getPostsByIdApi({String accountId, String postId}) async {
    var dataSend = {
      "accountId": accountId,
      "postId": postId??null
    };
